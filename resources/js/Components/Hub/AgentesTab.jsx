...
export const AgentesTab = () => {
  ...
  }, [debouncedSearch, revista, turno, debouncedCue, debouncedNorma, page, activeYear]);
    ...
    <div className="flex flex-col gap-6">
      ...
      <div>
        ...
        <p className="text-sm text-gray-500 font-semibold mt-1">
          Busca y visualiza los perfiles de agentes, sus cargos nominales e incompatibilidades de horas semanales.
        </p>
      </div>
          ...
          <table className="w-full text-left border-collapse min-w-max">
            <thead>
              <tr className="bg-gray-50 text-gray-400 text-[10px] font-black uppercase tracking-widest border-b border-gray-100">
                ...
                <th className="px-8 py-5">Carga Activa (Jerga)</th>
