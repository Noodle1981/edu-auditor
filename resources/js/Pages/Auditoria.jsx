...
const Auditoria = () => {
  ...
  return (
    <SIAMELayout>
      <Head title="Tablero de Auditoría" />
                ...
                <GlassCard className="p-8 bg-white flex flex-col justify-between border border-purple-100/50">
                  ...
                  <div className="grid grid-cols-2 gap-4 mt-6">
                    ...
                    <button
                      ...
                      className="px-4 py-3 bg-white border border-purple-150 text-purple-700 hover:bg-purple-50 rounded-2xl text-xs font-black uppercase tracking-wider shadow-sm active:scale-95 transition-all flex items-center justify-center gap-2 cursor-pointer"
                    >
                      ...
                      <GlassCard className="p-10 bg-emerald-50/10 border-dashed border-emerald-200 text-center flex flex-col items-center justify-center gap-4 shadow-sm backdrop-blur-md w-full my-4">
                        ...
                        <div className="flex flex-col gap-1.5 max-w-xl">
                          ...
                          <p className="text-xs font-semibold text-gray-500 leading-relaxed">
                            Los docentes en esta categoría no exceden los límites estatutarios vigentes y se consideran en situación regular en cuanto a su carga horaria activa.
                          </p>
                          <p className="text-xs font-semibold text-gray-400 mt-2">
                            Para consultar o auditar el expediente de un agente en situación regular, utilice el buscador del padrón en la sección de <a href="/agentes" className="text-[#FE8204] underline hover:text-[#FE8204]/80">Agentes</a> o ingrese su DNI directamente en la pestaña de <a href="/auditoria-unica" className="text-[#FE8204] underline hover:text-[#FE8204]/80">Auditoría Única</a>.
                          </p>
                        </div>
                      </GlassCard>
                    ) : (
                                    ...
                                    <td className="px-6 py-4 text-center">
                                      <div className="inline-flex items-center gap-2">
                                        ...
                                        <span className={`px-2 py-0.5 rounded text-[8px] font-black uppercase tracking-wider ${
                                          ...
                                          {agent.status_auditoria === 'exceso_justificado' ? 'Justificado' : 'Crítico'}
                                        </span>
                                      </div>
                                    </td>
                                  </tr>
